...
SECRET_KEY = os.environ.get('SECRET_KEY')  # nosec:B105
...
AUTHENTICATION_BACKENDS = [
    'social_core.backends.google.GoogleOAuth2', #Added 3rd party tool
    "django.contrib.auth.backends.ModelBackend",
    "guardian.backends.ObjectPermissionBackend",
]

# Added the new oauth specification
...
JIRA_USERNAME = os.environ.get('EMAIL')
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                'social_django.context_processors.backends', # Added 3rd party tool
                'social_django.context_processors.login_redirect', # Added 3rd party tool
            ],
            "loaders": [
...
INSTALLED_APPS = TENANT_APPS + [
    ...
    "tcms.telemetry",
    "tcms.rpc",
    'social_django', #Adding the 3rd party tool
]
